...
module nco_for_test (
	...
	nco_for_test_st	nco_for_test_st_inst(
		.phi_inc_i(phi_inc_i),
		.clk(clk),
		.reset_n(reset_n),
		.clken(clken),
...
// Retrieval info: <MEGACORE title="NCO"  version="7.2"  build="151"  iptb_version="1.3.0 Build 203"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION active_core="nco_for_test_st" >
...
// Retrieval info:      <PRIVATE name = "RCFC" value="nco_for_test_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="nco_for_test_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="nco_for_test_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="nco_for_test_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="nco_for_test_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="nco_for_test_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="nco_for_test_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="nco_for_test_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="nco_for_test_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="nco_for_test_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="nco_for_test_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="nco_for_test_sin_f.hex"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="80"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="28.5"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "TARGET" value="StratixII"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "DEVICE" value="StratixII"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="1530082099"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco_for_test_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco_for_test_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RSF" value="nco_for_test_sin.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSV" value="nco_for_test_sin.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSH" value="nco_for_test_sin.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCF" value="nco_for_test_cos.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCV" value="nco_for_test_cos.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCH" value="nco_for_test_cos.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="294"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="245760"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="60"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="nco_for_test.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="nco_for_test_gb.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "serializer"/>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="HC220F672I"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="HardCopy II"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:    </PRIVATES>
...
// =========================================================
// RELATED_FILES: nco_for_test_st.v, nco_for_test.v;
// IPFS_FILES: nco_for_test.vo;
// =========================================================
