...
void mlfDdc_func(int nargout, mxArray** ENOB, mxArray** SNR
                 , mxArray** SFDR_mdfy, mxArray** SINAD, mxArray* data_i
                 , mxArray* data_q, mxArray* numbit, mxArray* r, mxArray* fs)
{
    mclMlfFeval(_mcr_inst, "ddc_func", nargout, 4, 5, ENOB, SNR,
                SFDR_mdfy, SINAD, data_i, data_q, numbit, r, fs);
}
