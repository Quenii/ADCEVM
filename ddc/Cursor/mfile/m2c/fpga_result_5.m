...
fclk = fclk / r;
fid = fopen('IQ20101013004511DI.txt');

fpga_i = fscanf(fid,'%d')/ 2^(numbit-1);
fid1 = fopen('IQ20101013004511DQ.txt');
...
ADout_spect_1=fft(ADout_w,NFFT);
ADout_spect = fftshift(ADout_spect_1);
...
figure(1)
plot(X_FREQ1.*fclk/ad_len,-10,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-20,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-30,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-40,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-50,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-60,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-70,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-80,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-90,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-100,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-110,'-k');
hold on;
plot(X_FREQ.*fclk/ad_len,-120,'-k');
hold on;
plot(X_FREQ1.*fclk/ad_len,-130,'-k');
hold on;


%plot([0:round(ad_len/2)-1].*fclk/ad_len,ADout_dB(1:round(ad_len/2))-ref_dB);
%plot([0:round(ad_len/2)-1].*fclk/ad_len,ADout_dB(NFFT/2+1-(1:round(ad_len/2)))-ref_dB);         %把上面的反过来
%plot([0:(ad_len-1)].*fclk/ad_len,ADout_dB(1:ad_len)-ref_dB);

plot(X_FREQ.*fclk/ad_len,ADout_dB-ref_dB);
...
hold on;
plot(-Fh(2)*fclk,ADout_dB(Harbin_1(2))-ref_dB,'rv',-Fh(3)*fclk,ADout_dB(Harbin_1(3))-ref_dB,'rv',-Fh(4)*fclk,ADout_dB(Harbin_1(4))-ref_dB,'rv',-Fh(5)*fclk,ADout_dB(Harbin_1(5))-ref_dB,'rv', -Fh(6)*fclk,ADout_dB(Harbin_1(6))-ref_dB,'rv',-Fh(7)*fclk,ADout_dB(Harbin_1(7))-ref_dB,'rv',-Fh(8)*fclk,ADout_dB(Harbin_1(8))-ref_dB,'rv',-Fh(9)*fclk,ADout_dB(Harbin_1(9))-ref_dB,'rv',-Fh(10)*fclk,ADout_dB(Harbin_1(10))-ref_dB,'rv');
%plot([0:round(ad_len/2)-1].*fclk/ad_len,Pn_dB,'m-');
plot(X_FREQ.*fclk/ad_len,Pn_dB,'m-');
% 
% switch (NFFT)
%    case 16384
%      NFFT_txt = '16K';
...
FREQ_txt = strcat('BW =',num2str(2*BW/1e6,'%2d'),'MHz');
...
PndB_txt = strcat('PndB = ',num2str(Pn_dB,'%2.3f'),' dBc');
% THD_txt = strcat('THD: ',num2str(THD,'%2.3f'),' dB');
text(fclk*3.2/16,-5,FFT_txt,'HorizontalAlignment','left','Color','r');
text(fclk*3.2/16,-13,FREQ_txt,'HorizontalAlignment','left','Color','r');
text(fclk*3.2/16,-21,DBFS_txt,'HorizontalAlignment','left','Color','r');
text(fclk*3.2/16,-29,SNR_txt,'HorizontalAlignment','left','Color','r');
text(fclk*3.2/16,-37,SFDR_txt,'HorizontalAlignment','left','Color','r');
text(fclk*3.2/16,-45,PndB_txt,'HorizontalAlignment','left','Color','r');
...
text(-Fh(2)*fclk,ADout_dB(Harbin_1(2))-ref_dB+2,'2','VerticalAlignmen','bottom','Color','r');
text(-Fh(3)*fclk,ADout_dB(Harbin_1(3))-ref_dB+2,'3','VerticalAlignmen','bottom','Color','r');
text(-Fh(4)*fclk,ADout_dB(Harbin_1(4))-ref_dB+2,'4','VerticalAlignmen','bottom','Color','r');
text(-Fh(5)*fclk,ADout_dB(Harbin_1(5))-ref_dB+2,'5','VerticalAlignmen','bottom','Color','r');
text(-Fh(6)*fclk,ADout_dB(Harbin_1(6))-ref_dB+2,'6','VerticalAlignmen','bottom','Color','r');
text(-Fh(7)*fclk,ADout_dB(Harbin_1(7))-ref_dB+2,'7','VerticalAlignmen','bottom','Color','r');
text(-Fh(8)*fclk,ADout_dB(Harbin_1(8))-ref_dB+2,'8','VerticalAlignmen','bottom','Color','r');
text(-Fh(9)*fclk,ADout_dB(Harbin_1(9))-ref_dB+2,'9','VerticalAlignmen','bottom','Color','r');
text(-Fh(10)*fclk,ADout_dB(Harbin_1(10))-ref_dB+2,'10','VerticalAlignmen','bottom','Color','r');
hold on;
for i = 1:disturb_len
    hold on;
    plot(Fn_disturb(i)*fclk,ADout_dB(Harbin_disturb(i))-ref_dB,'g*');
end
hold off;
...
% A = [AmpMax,AmpMin];
% AdB = Vin;
HD = [ADout_dB(Harbin(2))-ref_dB,ADout_dB(Harbin(2))-ref_dB,ADout_dB(Harbin(3))-ref_dB,ADout_dB(Harbin(4))-ref_dB,ADout_dB(Harbin(5))-ref_dB,ADout_dB(Harbin(6))-ref_dB,ADout_dB(Harbin(7))-ref_dB,ADout_dB(Harbin