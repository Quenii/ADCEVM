...
typedef struct _IOCTLDATA
{
     ...
     *********************************************/
    //
    // The following definitions are taken from winioctl.h for the VxD driver
    //
...
typedef enum _DRIVER_MSGS
{
    ...
    MSG_INTR_ENABLE,
    MSG_INTR_DISABLE,
    MSG_INTR_ATTACH,                    // No longer supported
    MSG_INTR_WAIT,                      // No longer supported
    MSG_INTR_DETACH,
    MSG_INTR_STATUS_GET,
    MSG_BUS_IOP_READ,
    MSG_BUS_IOP_WRITE,
    ...
    MSG_POWER_LEVEL_SET,
    MSG_POWER_LEVEL_GET,
    MSG_PM_ID_READ,                     // No longer supported
    MSG_PM_NCP_READ,
    MSG_HS_ID_READ,                     // No longer supported
    MSG_HS_NCP_READ,
    MSG_HS_STATUS,
    MSG_VPD_ID_READ,                    // No longer supported
    MSG_VPD_NCP_READ,
    MSG_VPD_READ,
    MSG_VPD_WRITE,
    MSG_EEPROM_PRESENT,
    MSG_EEPROM_READ,                    // No longer supported
    MSG_EEPROM_READ_BY_OFFSET,
    MSG_EEPROM_WRITE,                   // No longer supported
