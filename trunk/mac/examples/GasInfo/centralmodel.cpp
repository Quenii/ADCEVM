...
//    setHorizontalHeaderItem( 2, new QStandardItem( "Date/Time" ));
    setHorizontalHeaderItem( 0, new QStandardItem( QString::fromLocal8Bit("??") ));
    setHorizontalHeaderItem( 1, new QStandardItem( QString::fromLocal8Bit("??") ));
    setHorizontalHeaderItem( 2, new QStandardItem( QString::fromLocal8Bit("??/??") ));
